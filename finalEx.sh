...
if [ $num1 -lt 0 ] || [ $num2 -lt 0 ] || [ $num3 -lt 0 ]; then
...
echo "before in prog $1"

local num1=$1
local num2=$2
local num3=$3

echo "after in prog $num1"
...
"re-input")echo "enter a series of 3 numbers gt 0";read -p "num1: " n1; read -p "num2: " n2; read -p "num3: " n3; prog1 $n1 $n2 $n3 ;;
"display-the-series")echo $num1 $num2 $num3;;
"low-to-high") sortArr $num1 $num2 $num3 ;; 
